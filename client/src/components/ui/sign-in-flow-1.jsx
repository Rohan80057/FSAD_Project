...
const DotMatrix = ({
    ...
    shader = "",
    center = ["x", "y"],
    animationSpeed = 10, // Default to a higher speed
}) => {
    ...
    return (
        ...
        void main() {
            ...
            if (u_reverse == 1) {
                ...
                // Keep visible after intro for persistent background
                // opacity *= step(current_timing_offset, u_time * animation_speed_factor);
                // opacity *= clamp((1.0 - step(current_timing_offset + 0.1, u_time * animation_speed_factor)) * 1.25, 1.0, 1.25);
                
                // Add constant wave movement
                float wave = sin(dist_from_center * 0.2 - u_time * 2.0);
                                    ...
                                    >
                                        ...
                                        <motion.button
                                            ...
                                            onClick={() => {
                                                ...
                                                localStorage.setItem('user', JSON.stringify({ name: 'Developer', email: email || 'demo@example.com' }));
                                                // Force reload to ensure AuthContext picks up the change if it doesn't listen to storage events
